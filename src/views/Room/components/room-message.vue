...
// 展示图片的函数
const previewImages = (pictures?: Image[]) => {
  ...
  <template v-for="item in list" :key="item.id">
    ...
    <div class="msg msg-illness" v-if="item.msgType === 21">
      ...
      <van-row>
        ...
        <van-col
          span="18"
          @click="previewImages(item.msg.consultRecord?.pictures)"
          >点击查看</van-col
        >
      </van-row>
    </div>
    ...
    >
      <div class="content">
        <div class="time">{{ item.createTime.slice(-8) }}</div>
